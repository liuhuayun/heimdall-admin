CREATE DATABASE  IF NOT EXISTS `heimdall_admin_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `heimdall_admin_db`;
...
--
-- Dumping data for table `m_dict_type`
--

LOCK TABLES `m_dict_type` WRITE;
/*!40000 ALTER TABLE `m_dict_type` DISABLE KEYS */;
INSERT INTO `m_dict_type` VALUES (1332954329350455297,1332660082902622210,'2020-11-29 15:47:31.868000',1332660082902622210,'2020-11-29 15:47:31.868000','性别',NULL,'gender'),(1333005358104436737,1332660082902622210,'2020-11-29 19:10:18.072000',1332660082902622210,'2020-11-29 19:10:18.072000','站内信分类',NULL,'messageType');
/*!40000 ALTER TABLE `m_dict_type` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `m_message` VALUES (1356168497536753666,NULL,NULL,NULL,NULL,NULL,NULL,'鸡蛋便宜了...',1,'2021-02-01 17:12:20.861000',1332660082902622210,'鸡蛋便宜了...');
/*!40000 ALTER TABLE `m_message` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_message_box`
--

DROP TABLE IF EXISTS `m_message_box`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_message_box` (
  `id` bigint(20) NOT NULL,
  `created_by` bigint(20) DEFAULT NULL,
  `created_time` datetime(6) DEFAULT NULL,
  `last_modified_by` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `m_message_box`
--

LOCK TABLES `m_message_box` WRITE;
/*!40000 ALTER TABLE `m_message_box` DISABLE KEYS */;
INSERT INTO `m_message_box` VALUES (1356168608555786241,NULL,NULL,NULL,NULL,NULL,NULL,1356168497536753666,1,'2021-02-01 17:12:47.331000',1321506328853696514,1,'鸡蛋便宜了...');
/*!40000 ALTER TABLE `m_message_box` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `m_post` VALUES (1332654295924903938,0,'2020-11-28 19:55:18.312000',0,'2020-11-28 19:55:18.312000','',0,'首席执行官','CEO',1,0),(1332654322680369153,0,'2020-11-28 19:55:24.704000',0,'2020-11-28 19:55:24.704000','',0,'首席财务官','CFO',1,0),(1332654372030550017,0,'2020-11-28 19:55:36.470000',0,'2020-11-28 19:55:36.470000','',0,'首席外星人','UFO',1,2);
/*!40000 ALTER TABLE `m_post` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_post_user`
--

DROP TABLE IF EXISTS `m_post_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_post_user` (
...
--
-- Dumping data for table `m_post_user`
--

LOCK TABLES `m_post_user` WRITE;
/*!40000 ALTER TABLE `m_post_user` DISABLE KEYS */;
INSERT INTO `m_post_user` VALUES (1332660082902622210,1332654295924903938),(1333060149291634690,1332654295924903938),(1332660082902622210,1332654322680369153),(1332660767639527426,1332654322680369153),(1332661269903212545,1332654322680369153),(1332660082902622210,1332654372030550017),(1332661471821201410,1332654372030550017),(1333060149291634690,1332654372030550017);
/*!40000 ALTER TABLE `m_post_user` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `m_resource` VALUES (1321510438613082113,NULL,'2020-10-29 01:53:35.684000',1321506328853696514,'2020-11-24 20:41:59.296000','管理系统用户\\角色资源等信息',NULL,1,'fas fa-cog',NULL,'Sys',NULL,0,1,'系统管理',NULL,0,1,NULL,'Layout',0,'/sys',1000),(1321510438801825793,NULL,'2020-10-29 01:53:35.745000',1321506328853696514,'2020-11-24 20:58:14.690000','管理系统用户信息，启用禁用账户,重置密码',NULL,1,'far fa-address-card',NULL,'SysUser',NULL,1321510438613082113,2,'用户管理','',0,1,NULL,'@views/sys/user/index',0,'/sys/user',999),(1321510438801825794,1321506328853696514,'2020-10-29 01:53:35.745000',1321506328853696514,'2020-11-07 21:31:20.034000','管理系统角色，为角色分配系统权限',NULL,1,'fas fa-users',NULL,'SysRole',NULL,1321510438613082113,2,'角色管理','',0,1,NULL,'@views/sys/role/index',0,'/sys/role',998),(1321510438801825795,1321506328853696514,'2020-10-29 01:53:35.745000',1332660082902622210,'2020-11-29 23:25:48.835000','管理系统访问日志，可以查看系统访问情况',NULL,1,'fas fa-align-justify',NULL,'SysSysLog',NULL,1321510438613082113,2,'系统日志','',0,1,NULL,'@views/sys/syslog/index',0,'/sys/log',991),(1321510438801825796,1321506328853696514,'2020-10-29 01:53:35.745000',1321506328853696514,'2020-11-24 20:42:09.940000','管理系统内菜单和资源权限，设置菜单图标文字等信息，修改系统资源信息，会影响系统权限判断逻辑，修改不当，可能导致系统无法正确访问',NULL,1,'fas fa-cubes',NULL,'SysResource',NULL,1321510438613082113,2,'资源管理','',0,1,NULL,'@views/sys/resource/index',0,'/sys/resource',995),(1322514297393299458,1321506328853696514,'2020-10-31 20:22:34.280000',1321506328853696514,'2020-11-22 22:09:37.938000','',0,1,'fas fa-user-plus','','saveSysUser','sys:user:save',1321510438801825793,3,'添加用户','/sys/user/save',0,1,'',NULL,0,NULL,0),(1322514406554255361,1321506328853696514,'2020-10-31 20:23:00.309000',1321506328853696514,'2020-11-22 22:07:39.579000','',0,1,'far fa-edit','','updateSysUser','sys:user:update',1321510438801825793,3,'修改用户','/sys/user/update',0,1,'',NULL,0,NULL,0),(1324555351789527042,1321506328853696514,'2020-11-06 11:32:59.572000',1321506328853696514,'2020-11-22 22:02:23.831000','系统字典分类和字典数据管理，实现枚举值的字典化统一管理',NULL,1,'fas fa-wallet',NULL,'SysDict',NULL,1321510438613082113,2,'系统字典',NULL,0,1,NULL,'@views/sys/dict/index',0,'/sys/dict',992),(1324766365478912002,1321506328853696514,'2020-11-07 01:31:29.156000',1321506328853696514,'2020-11-22 22:08:02.648000',NULL,NULL,1,'fas fa-list-ol',NULL,'SysUserList','sys:user:list',1321510438801825793,3,'查看系统用户列表数据','/sys/user/list',0,1,NULL,'',1,'',0),(1327636209513574401,1321506328853696514,'2020-11-14 23:35:13.294000',1321506328853696514,'2020-11-22 22:02:49.316000','站内信的管理、发送、删除等',NULL,1,'fas fa-volume-up',NULL,'SysMessage',NULL,1321510438613082113,2,'站内消息',NULL,0,1,NULL,'@views/sys/message/index',0,'/sys/message',994),(1328243256491786241,1321506328853696514,'2020-11-16 15:47:24.572000',1321506328853696514,'2020-11-16 16:01:32.727000','查看系统日志列表',NULL,1,'fas fa-egg',NULL,'SysLogList','sys:log:list',1321510438801825795,3,'查看系统日志列表','/sys/log/list',0,1,NULL,'',1,'',0),(1329391155728654337,1321506328853696514,'2020-11-19 19:48:45.076000',1332660082902622210,'2020-11-29 21:58:34.998000','查看当前在线用户，强制用户下线',NULL,1,'fas fa-diagnoses',NULL,'SysOnlineUser',NULL,1321510438613082113,2,'在线用户',NULL,0,1,NULL,'@/views/sys/onlineuser/index',0,'/sys/onlineuser',993),(1329456580344688642,1321506328853696514,'2020-11-20 00:08:43.521000',1321506328853696514,'2020-11-23 01:28:31.942000',NULL,NULL,1,'fas fa-users',NULL,'SysOnlineUserList','sys:online:list',1329391155728654337,3,'查看在线用户列表','/sys/online/list',0,1,NULL,'',1,'',0),(1329460795418869762,1321506328853696514,'2020-11-20 00:25:28.473000',1321506328853696514,'2020-11-20 00:25:28.473000',NULL,NULL,1,'fas fa-egg',NULL,'S