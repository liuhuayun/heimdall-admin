...
public class SysMessageController extends BaseJpaController {
    ...
    @ApiOperation(value = "根据ID查询单条系统消息记录详情", notes = "根据ID查询单条系统消息记录详情", response = ResponseVO.class)
    @SysLog(value = "根据ID查询单条系统消息记录详情", type = BizType.DETAIL)
     ...
     */
    @GetMapping("/list")
    @ApiOperation(value = "系统消息列表数据查询", notes = "系统消息列表数据查询", response = PageDTO.class)
    @SysLog(value = "系统消息列表数据查询", type = BizType.LIST)
     ...
     */
    @PostMapping("/save")
    @ApiOperation(value = "新增系统消息数据", notes = "新增系统消息数据", response = ResponseVO.class)
    @SysLog(value = "新增系统消息数据", type = BizType.INSERT)
     ...
     */
    @PostMapping("/update")
    @ApiOperation(value = "修改系统消息数据", notes = "修改系统消息数据", response = ResponseVO.class)
    @SysLog(value = "修改系统消息数据", type = BizType.UPDATE)
    ...
    @ApiOperation(value = "删除系统消息数据", notes = "删除系统消息数据", response = ResponseVO.class)
    @SysLog(value = "根据ID删除单条系统消息记录", type = BizType.DELETE)
     ...
     */
    @PostMapping("/exist")
    @ApiOperation(value = "判断系统消息某个属性值是否存在", notes = "判断系统消息某个属性值是否存在", response = ResponseVO.class)
    @SysLog
    public ResponseEntity<ResponseVO<Boolean>> isExisted(String prop, String value) {
        ...
        return ResponseUtils.ok("", sysMessageService.isExist(SysMessageEntity.class, prop, value));
    }
}
