...
public class SysPostController extends BaseJpaController {
    ...
    @ApiOperation(value = "根据ID查询单条岗位职责记录详情", notes = "根据ID查询单条岗位职责记录详情", response = ResponseVO.class)
    @SysLog(value = "根据ID查询单条岗位职责记录详情", type = BizType.DETAIL)
     ...
     */
    @GetMapping("/list")
    @ApiOperation(value = "岗位职责列表数据查询", notes = "岗位职责列表数据查询", response = PageDTO.class)
    @SysLog(value = "岗位职责列表数据查询", type = BizType.LIST)
     ...
     */
    @PostMapping("/save")
    @ApiOperation(value = "新增岗位职责数据", notes = "新增岗位职责数据", response = ResponseVO.class)
    @SysLog(value = "新增岗位职责数据", type = BizType.INSERT)
     ...
     */
    @PostMapping("/update")
    @ApiOperation(value = "修改岗位职责数据", notes = "修改岗位职责数据", response = ResponseVO.class)
    @SysLog(value = "修改岗位职责数据", type = BizType.UPDATE)
    ...
    @ApiOperation(value = "删除岗位职责数据", notes = "删除岗位职责数据", response = ResponseVO.class)
    @SysLog(value = "根据ID删除单条岗位职责记录", type = BizType.DELETE)
     ...
     */
    @PostMapping("/exist")
    @ApiOperation(value = "判断岗位职责某个属性值是否存在", notes = "判断岗位职责某个属性值是否存在", response = ResponseVO.class)
    @SysLog
